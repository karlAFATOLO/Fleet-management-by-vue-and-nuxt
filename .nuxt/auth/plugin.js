...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/auth/login","method":"post","propertyName":"token"},"logout":false,"user":{"url":"/auth/me","method":"get","propertyName":false},"register":{"url":"/auth/register","method":"post","propertyName":"token"}},"_name":"local"}))
